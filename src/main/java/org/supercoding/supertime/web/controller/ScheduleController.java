...
public class ScheduleController {
    ...
    @PostMapping("/view")
    public ResponseEntity<ScheduleResponseDto> getSchedule(@RequestBody CreateSemesterRequestDto createSemesterInfo){
        log.info("[SCHEDULE] 시간표 조회 요청이 들어왔습니다.");
        ScheduleResponseDto getScheduleResult = scheduleService.getSchedule(createSemesterInfo);
